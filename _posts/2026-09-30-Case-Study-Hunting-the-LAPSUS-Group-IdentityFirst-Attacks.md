...
tags: [Identity]
description: How LAPSUS$ bypassed traditional defenses using identity-centric techniques and what it means for hunting authentication and MFA abuse.
---



![Identity-first LAPSUS$ techniques forming paths through credentials sessions and trusted access](/assets/img/threat-hunting/attacker-path.svg)
