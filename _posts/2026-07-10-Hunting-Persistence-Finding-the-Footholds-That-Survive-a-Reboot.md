...
tags: [Persistence]
description: A complete guide to hunting the persistence mechanisms attackers rely on to maintain access across reboots, credential changes, and time.
---



![Persistence choices modeled as alternative routes that preserve attacker access](/assets/img/threat-hunting/attacker-path.svg)
