...
tags: [Metrics]
description: How to define and present threat hunting metrics that demonstrate real program value instead of vanity numbers nobody trusts.
---



![Threat hunting metrics matched to program maturity capacity and operating model](/assets/img/threat-hunting/program-models.svg)
