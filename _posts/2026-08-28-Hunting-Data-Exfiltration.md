...
tags: [Exfiltration]
description: Data theft rarely looks dramatic on the wire. Here's how to hunt exfiltration across HTTP, DNS, cloud storage, and covert channels.
---



![Data exfiltration investigated from volume and destination patterns into detailed evidence](/assets/img/threat-hunting/network-hunting-evidence.svg)
