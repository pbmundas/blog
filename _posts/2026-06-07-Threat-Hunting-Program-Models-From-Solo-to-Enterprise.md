...
- Choose an operating model that fits current capacity and telemetry.
- Understand what changes as a team grows.
- Avoid copying enterprise processes into a program that cannot sustain them.
