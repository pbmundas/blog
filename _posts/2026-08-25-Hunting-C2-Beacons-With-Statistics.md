...
tags: [C2]
description: Beacons hide in normal-looking traffic. Here's how to use frequency and statistical analysis to find periodic C2 communication reliably.
---



![C2 beacon timing identified as a statistical deviation worth investigating](/assets/img/threat-hunting/behavior-baseline.svg)
