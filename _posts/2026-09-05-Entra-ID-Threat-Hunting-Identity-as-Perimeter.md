...
tags: [Entra ID]
description: Master hunting identity attacks in Microsoft Entra ID sign-in anomalies, conditional access gaps, and privileged role abuse.
---



![Entra ID activity treated as the identity control plane for cloud access](/assets/img/threat-hunting/cloud-control-plane.svg)
