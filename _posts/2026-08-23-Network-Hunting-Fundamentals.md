...
tags: [Network]
description: Core network hunting skills across NetFlow, packet capture, proxy logs, and firewall data what your traffic is actually telling you.
image:
  path: /assets/img/threat-hunting/network-hunting-evidence.svg
  alt: "Network hunting evidence layers from flow and DNS to protocol metadata and packets"
---



![Network hunting evidence progressing from flow and DNS to metadata and packets](/assets/img/threat-hunting/network-hunting-evidence.svg)
