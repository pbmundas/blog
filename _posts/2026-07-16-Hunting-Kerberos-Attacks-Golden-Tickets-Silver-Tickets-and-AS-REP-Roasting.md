...
description: A deep dive into hunting Golden Ticket, Silver Ticket, and AS-REP roasting attacks against Kerberos authentication in Active Directory.
---



![Kerberos abuse used to move from stolen identity material toward privileged access](/assets/img/threat-hunting/attacker-path.svg)
