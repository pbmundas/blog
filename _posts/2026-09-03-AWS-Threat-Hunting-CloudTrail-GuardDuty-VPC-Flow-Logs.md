...
tags: [AWS]
description: Build real AWS hunting capability across CloudTrail, GuardDuty findings, and VPC Flow Logs the telemetry that actually matters.
---



![AWS hunting correlating CloudTrail GuardDuty workload and VPC flow evidence](/assets/img/threat-hunting/cloud-control-plane.svg)
