...
description: How to detect the techniques attackers use to escalate from a standard user account to administrator or SYSTEM-level access.
---



![Privilege escalation as a decision point on an attacker path](/assets/img/threat-hunting/attacker-path.svg)
