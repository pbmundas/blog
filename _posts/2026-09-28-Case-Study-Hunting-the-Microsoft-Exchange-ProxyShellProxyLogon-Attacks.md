...
tags: [Exchange]
description: How ProxyLogon and ProxyShell exploitation unfolded against Exchange servers, and what it teaches about hunting for web shell activity.
---



![Exchange exploitation traced from delivery and exploitation through persistence and objectives](/assets/img/threat-hunting/kill-chain-hunting-map.svg)
