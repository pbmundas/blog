...
- Apply competing hypotheses, devil's advocacy, and key-assumptions checks.
- Evaluate evidence for diagnostic value instead of counting supporting facts.
- Recognize premature closure and confirmation bias during triage.
