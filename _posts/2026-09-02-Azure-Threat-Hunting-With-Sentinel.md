...
tags: [Azure]
description: Build real Azure hunting capability using Azure Monitor and Sentinel sign-in logs, activity logs, and KQL hunts that actually work.
---



![Azure and Sentinel evidence connected across identity control plane workloads and network activity](/assets/img/threat-hunting/cloud-control-plane.svg)
