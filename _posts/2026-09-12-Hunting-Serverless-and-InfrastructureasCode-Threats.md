...
tags: [Serverless]
META DESCRIPTION: Serverless functions and IaC templates create attack surfaces most hunting programs haven't caught up to yet. Here's where to start.
---
...
ThreatHuntLabs' serverless and IaC hunting module works through invocation log analysis, execution role auditing, and infrastructure drift detection against realistic scenarios covering both attack surfaces a solid foundation to build on while the broader industry practice around this area continues catching up.
