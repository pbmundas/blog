---
title: Mapping the SOC Data Ecosystem
date: 2026-06-06 12:00:00 +0530
categories: [Threat Hunting, Threat Hunting Programs]
tags: [data sources, telemetry, SOC]
description: A practical map of every data source available to a threat hunter, what each one actually reveals, and where the blind spots hide.
image:
  path: /assets/img/threat-hunting/soc-data-ecosystem.svg
  alt: "Endpoint, identity, network, cloud, and SaaS telemetry flowing into a hunting platform"
---

## What you will learn

- Match common hunt questions to endpoint, identity, network, cloud, and SaaS evidence.
- Identify whether a hunt is feasible before writing queries.
- Build a data inventory that records coverage, retention, ownership, and known gaps.
...
Create one row per data source with these fields: owner, covered assets, event types, searchable fields, collection delay, retention, access method, and known gaps. Then select one hypothesis and mark each required field as **available**, **partial**, or **missing**. This simple exercise prevents a missing telemetry field from masquerading as a clean result.

## Key takeaway

A hunter does not merely know that a log source exists. They know what it records, what it omits, how long it survives, and whether it can answer the question being asked.
