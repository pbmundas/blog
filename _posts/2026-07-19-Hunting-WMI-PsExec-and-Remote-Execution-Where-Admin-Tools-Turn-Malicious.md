...
description: Detecting remote execution techniques that deliberately blend with legitimate IT administration, from PsExec to WMI and remote PowerShell.
---



![Remote administration investigated through source identity destination and resulting process ancestry](/assets/img/threat-hunting/windows-process-tree.svg)
