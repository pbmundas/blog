...
tags: [Execution]
description: A hunter's guide to detecting execution techniques used after initial access, from scripting interpreters to scheduled task abuse.
---



![Execution evidence revealed through process ancestry and context](/assets/img/threat-hunting/windows-process-tree.svg)
