...
tags: [OAuth]
description: Illicit OAuth consent grants bypass MFA and survive password resets. Here's how to hunt malicious app consent in Entra ID specifically.
---



![OAuth consent and token abuse creating alternate paths to cloud data](/assets/img/threat-hunting/attacker-path.svg)
