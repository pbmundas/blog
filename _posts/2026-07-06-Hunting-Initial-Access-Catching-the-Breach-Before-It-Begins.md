...
tags: [Initial Access]
description: How to hunt for the techniques adversaries use to gain their first foothold, before it turns into a deeper compromise.
---



![Initial access as the earliest internal hunting opportunity](/assets/img/threat-hunting/kill-chain-hunting-map.svg)
