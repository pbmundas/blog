...
tags: [AWS]
META DESCRIPTION: How an SSRF vulnerability led to a major cloud data breach, and the hunt hypotheses that catch this attack pattern in AWS environments.
---
