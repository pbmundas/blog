...
tags: [Collection, CTI]
description: Detecting adversaries gathering and staging data before exfiltration, the quiet window between compromise and actual data loss.
---



![Collection and staging examined across endpoint file and network evidence](/assets/img/threat-hunting/network-hunting-evidence.svg)
