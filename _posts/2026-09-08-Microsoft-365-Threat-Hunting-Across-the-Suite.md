...
tags: [Microsoft 365]
description: M365 compromise rarely stays in one app. Here's how to hunt across Exchange, SharePoint, and Teams using Unified Audit Log data.
---
...
This one's almost a clichÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© at this point among people who do this work, and it stays on every list for a reason: inbox rules that forward mail externally, or that silently delete/move incoming messages to obscure folders, are one of the most consistent indicators of a compromised mailbox across essentially every phishing and BEC investigation. Attackers set these up specifically to maintain visibility into ongoing conversations waiting for an invoice thread, watching for password reset emails without the victim noticing anything's different about their inbox day to day.
