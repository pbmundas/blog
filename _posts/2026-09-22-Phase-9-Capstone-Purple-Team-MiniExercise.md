...
tags: [Capstone]
description: A walkthrough of running a complete purple team mini-exercise, from scenario planning through validated detection deployment.
---



![Purple-team capstone progressing from hypothesis and emulation through evidence and improvement](/assets/img/threat-hunting/first-hunt-workflow.svg)
