...
tags: [Capstone]
description: A full network-based intrusion investigation, working entirely from packet capture the capstone that tests real analytical judgment.
---



![PCAP capstone progressing from hypothesis through packet evidence and reporting](/assets/img/threat-hunting/first-hunt-workflow.svg)
